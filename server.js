...
// Connect to MongoDB online version using the link ans stockApp is the name of the database
mongoose.connect('mongodb+srv://project:project@cluster0.kos1k7l.mongodb.net/stockApp', {
    useNewUrlParser: true,
    useUnifiedTopology: true,
});
// this is where the data type declaration
//  is done  for my database
...
// function logic to get stock data using axios
...
app.get('/', ensureAuthenticated, async (req, res) => {
    try {
        ...
        // shows the index page with the stock data requested by user if there is no error
...
app.get('/', ensureAuthenticated, async (req, res) => {
    try {
        ...
        // Calculate chart data nad creates chart donut based on the data like symbol and sum of qty vs price
...
// function to limit the number of stocks users can add to 5 to limit api usage
...
// function logic to delete stocks
...
// login,register and logout logic and routes using passport.LocalStrategy
...
app.post('/register', async (req, res) => {
    ...
    try {
        // bcrypt is a package which converts users paswword into code so that humans can identiy
        //  them and the 10 is delay added for security
